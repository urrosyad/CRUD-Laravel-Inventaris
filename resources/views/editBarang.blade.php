                                ...
                                <div class="card h-full">
                                    <div class="card-body">
                                        <div class="flex justify-between items-center mb-5">
                                            <h5 class="text-gray-500 text-xl font-bold">Edit Barang</h5>
                                        </div>
                                        <div class="flex flex-col gap-6">
                                            <form action="{{ route('barang.update', $barang->id) }}" method="POST"
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    {{-- Nama Barang --}}
                                                    <label class="block text-sm mb-2 text-gray-400">Nama
                                                        Barang</label>
                                                    <input type="text" name="nama_barang"
                                                        value="{{ old('nama_barang', $barang->namaBarang) }}"
                                                        class="py-3 px-4 text-gray-500 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                                                        required>

                                                    {{-- Kode Barang --}}
                                                    <label class="block text-sm mb-2 text-gray-400 mt-4">Kode
                                                        Barang</label>
                                                    <input type="text" name="kode_barang"
                                                        value="{{ old('kode_barang', $barang->kodeBarang) }}"
                                                        class="py-3 px-4 text-gray-500 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                                                        required>

                                                    {{-- Harga --}}
                                                    <label class="block text-sm mb-2 text-gray-400 mt-4">Harga
                                                        Barang</label>
                                                    <input type="number" name="harga_barang"
                                                        value="{{ old('harga_barang', $barang->satuanBarang) }}"
                                                        class="py-3 px-4 text-gray-500 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                                                        required>

                                                    {{-- Jumlah --}}
                                                    <label class="block text-sm mb-2 text-gray-400 mt-4">Jumlah
                                                        Barang</label>
                                                    <input type="number" name="jumlah_barang"
                                                        value="{{ old('jumlah_barang', $barang->jumlahBarang) }}"
                                                        class="py-3 px-4 text-gray-500 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                                                        required>

                                                    {{-- Deskripsi --}}
                                                    <label
                                                        class="block text-sm mb-2 text-gray-400 mt-4">Deskripsi</label>
                                                    <input type="text" name="deskripsi_barang"
                                                        value="{{ old('deskripsi_barang', $barang->deskBarang) }}"
                                                        class="py-3 px-4 text-gray-500 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0">

                                                    {{-- Foto Barang --}}
                                                    <label class="block text-sm mb-2 text-gray-400 mt-4">Foto
                                                        Barang</label>
                                                ...
                                                <button type="submit"
                                                    class="btn text-base py-2.5 rounded-md text-white font-medium bg-blue-600 hover:bg-blue-700">
                                                    Submit
                                                </button>
                                            </form>
                                        </div>
